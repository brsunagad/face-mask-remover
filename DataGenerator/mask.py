...
def create_mask(image_path):
    pic_path = image_path
    mask_images = ["masks/facemask1.png", "masks/facemask2.png", "masks/facemask3.png", "masks/facemask4.png"]
    mask_path = random.choice(mask_images)
    show = False
    model = "hog"
...
class FaceMasker:
    ...
    def __init__(self, face_path, mask_path, show=False, model='hog'):
        ...
        self._face_img1: ImageFile = None
    ...
    def mask(self):
        ...
        self._face_img1 = Image.fromarray(face_image_np)
    ...
    def _save(self):
        ...
        new_face_path = "with-masks/" +self.face_path
        new_image = Image.new('RGB', (2 * self._face_img1.size[0], self._face_img1.size[1]), (250, 250, 250))
        new_image.paste(self._face_img1, (0, 0))
        new_image.paste(self._face_img, (self._face_img1.size[0], 0))
        #self._face_img.save(new_face_path)
        new_image.save(new_face_path)
...
if __name__ == '__main__':
    #cli()
    create_mask("celebfaces/000055.jpg")